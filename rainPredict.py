...
st.set_page_config(
    ...
    page_icon="🌧️",
    layout="wide",  # make layout wide for better left-right split
    initial_sidebar_state="expanded",
)

# Dark mode + background image styling WITHOUT the black container
st.markdown(
    """
    <style>
    body, .stApp {
...
# Create two columns: left for Location + Map, right for all other inputs
...
# Prepare input data dictionary for prediction
input_data = {
    'MinTemp': min_temp,
    'MaxTemp': max_temp,
    'Rainfall': rainfall,
