...
# Load your model and feature names
...
st.markdown(
    """
    Predict if it will rain tomorrow based on today's weather data.  
    Fill in the inputs below and see the city location on the map.
    """
)
...
with st.expander("Cloud Cover", expanded=False):
    cloud_9am = st.slider("Cloud Cover at 9am (0–8 oktas)", 0, 8, 4)
    cloud_3pm = st.slider("Cloud Cover at 3pm (0–8 oktas)", 0, 8, 5)
...
# Encode categorical variables as one-hot columns
...
st.markdown(
    """
    <style>
    footer {visibility: visible; text-align: center; color: #999; margin-top: 2rem;}
    </style>
    <footer>
