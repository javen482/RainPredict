...
sunshine = st.number_input("Sunshine (hours)", 0.0, 15.0, 8.0)
...
cloud_9am = st.slider("Cloud Cover at 9am (0–8 oktas, where 0 = clear sky and 8 = completely overcast)", 0, 8, 4)
cloud_3pm = st.slider("Cloud Cover at 3pm (0–8 oktas, where 0 = clear sky and 8 = completely overcast)", 0, 8, 5)
...
# --- Add categorical columns as one-hot ---
# Set all Location_, Season_, WindGustDir_, WindDir9am_, WindDir3pm_ columns explicitly
for col in feature_names:
    if col.startswith("Location_"):
        ...
        # Make sure all columns exist, fill missing with 0
...
if st.button("Predict Rain Tomorrow"):
    ...
    label = "Yes ☔" if prediction == 1 else "No 🌤️"
    st.success(f"Will it rain tomorrow? {label}")
